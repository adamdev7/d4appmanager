    ...
    async def plan_complete(
        ...
        *,
        ...
        user = (
            ...
            "UNBOXING = first-touch reveal. MACRO = extreme close-up of materials. "
            "FLAT_LAY = editorial overhead. STREET_STYLE = candid outdoor fashion. "
            "PROMOTIONAL and PROBLEM_SOLUTION stills get selling copy burned into the frame: their headline must "
            "be 30 characters or fewer and their scene must keep a flat, uncluttered top band and bottom strip "
            "for that copy. Every other still, and every clip, is a CLEAN PLATE with no on-screen text. "
