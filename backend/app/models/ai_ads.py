...
class AIAdsSettingsUpdate(BaseModel):
    ...
    image_count: int | None = Field(default=None, ge=0, le=40)
    video_count: int | None = Field(default=None, ge=0, le=40)
...
class AIAdsGenerationJobRequest(BaseModel):
    product_id: str
    image_count: int = Field(default=10, ge=0, le=40)
    video_count: int = Field(default=10, ge=0, le=40)
